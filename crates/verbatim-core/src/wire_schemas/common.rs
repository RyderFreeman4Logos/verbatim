...
pub enum WireArtifactKind {
    ...
    AskErrorEvent,
    AskCitationEvent,
    AskCollectionFilterEvent,
    AskRetrievalDebugEvent,
    TaskRun,
    TaskProfile,
    TaskEvents,
    TaskList,
    ...
    SourceListResult,
    DeletionReportListResult,
    DeletionReportResult,
    SourceCreated,
    SourceRecord,
    IngestResult,
    ReindexResult,
...
impl WireArtifactKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AskRun => "ask_run",
            Self::AskTokenEvent => "ask_token_event",
            Self::AskErrorEvent => "ask_error_event",
            Self::AskCitationEvent => "ask_citation_event",
            Self::AskCollectionFilterEvent => "ask_collection_filter_event",
            Self::AskRetrievalDebugEvent => "ask_retrieval_debug_event",
            Self::TaskRun => "task_run",
            Self::TaskProfile => "task_profile",
            Self::TaskEvents => "task_events",
            Self::TaskList => "task_list",
            Self::TaskCreated => "task_created",
            Self::CollectionListResult => "collection_list_result",
            Self::SourceListResult => "source_list_result",
            Self::DeletionReportListResult => "deletion_report_list_result",
            Self::DeletionReportResult => "deletion_report_result",
            ...
            Self::CollectionResult => "collection_result",
            ...
            Self::CheckStaleResult => "check_stale_result",
            Self::IndexStatusResult => "index_status_result",
            Self::IndexGcResult => "index_gc_result",
            Self::IndexProfileDeleteResult => "index_profile_delete_result",
