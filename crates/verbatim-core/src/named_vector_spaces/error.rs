...
pub enum NamedVectorSpaceDiagnosticCode {
    ...
    OriginalVectorsRequired,
    InvalidExactInteractionVectors,
...
impl NamedVectorSpaceDiagnosticCode {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::OriginalVectorsRequired => "original_vectors_required",
            Self::InvalidExactInteractionVectors => "invalid_exact_interaction_vectors",
